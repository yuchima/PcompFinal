...
//CC2540SensorTag.prototype.enableAccelerometer = function(callback) {
//  this.writeUInt8Characteristic(ACCELEROMETER_UUID, ACCELEROMETER_CONFIG_UUID, 0x03, callback);
//}
...
//// Nov 30 JuanGotama: the sensorTag CC2540's accel. range is default +-2G, need to be set to +-8G
//CC2540SensorTag.prototype.setAccelerometerRangeToMax = function(callback) {
//  this.writeUInt8Characteristic(ACCELEROMETER_UUID, ACCELEROMETER_CONFIG_UUID, 0x03, callback);
//}
...
// Nov 30 JuanGotama: this formula is based on +-8G range; changed to +-2G
